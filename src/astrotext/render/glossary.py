...
TERMS: list[tuple[str, str]] = [
    ...
    # vedic
    ("sidereal zodiac (nirayana)", "恒星黄道"), ("ayanamsa", "岁差差值(回归-恒星)"),
    ("Lagna", "上升点(印度)"), ("graha", "曜(九曜)"),
    ("Rahu", "罗睺(北交)"), ("Ketu", "计都(南交)"),
    ("nakshatra", "二十七宿"), ("pada", "宿足(四分之一宿)"),
    ("varga / divisional chart", "分盘"), ("Navamsa (D9)", "九分盘"),
    ("Dashamsa (D10)", "十分盘"), ("vargottama", "分盘同宫(D1==D9)"),
    ("Vimshottari dasha", "一百二十年大运"), ("mahadasha", "大运主期"),
    ("antardasha", "大运副期"), ("pratyantardasha", "大运三级期"),
    ("panchanga", "五要素历"), ("tithi", "月相日"), ("karana", "半月相日"),
    ("yoga (panchanga)", "日月合距瑜伽"), ("paksha", "月相半月(白/黑)"),
    ("chara karaka", "查拉卡拉卡(行运载体星)"),
    ("Atmakaraka (AK)", "自我载体星"), ("graha drishti", "星体相映"),
    # time
